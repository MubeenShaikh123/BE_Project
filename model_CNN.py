...
path1 = 'D:\lungs Detection\Dataset\train_set\1' # train 0,1 pending #path of folder of images    
path2 = 'D:\lungs Detection\Dataset\train\1'  #path of folder to save images 
