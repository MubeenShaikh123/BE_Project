def main():
    ...
    # dataset path only folder 
    basepath="D:\lungs Detection\Dataset"
    ...
    model = classifier.fit_generator(
            ...
            epochs=50,# epochs is used for depends on your peoject dataset
    ...
    #Saving the model
    #import h5py
    classifier.save(basepath + '/Lungs_model.h5')
